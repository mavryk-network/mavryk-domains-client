import { TezosDomainsConfig, TezosClient, AddressBook, ConsoleTracer, NoopTracer, TezosDomainsValidator } from '@tezos-domains/core';
...
export class TezosDomainsResolver implements NameResolver {
    ...
    constructor(config: ResolverConfig) {
        ...
        const validator = new TezosDomainsValidator(config);
