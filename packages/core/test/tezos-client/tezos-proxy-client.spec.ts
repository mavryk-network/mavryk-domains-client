import { TezosProxyClient, TezosClient, ProxyContractAddressResolver, RpcResponseData } from '@tezos-domains/core';
...
describe('TezosProxyClient', () => {
    ...
    describe('getBigMapValue()', () => {
        it('should get value from bigmap', async () => {
            ...
            expect(capture<string, (storage: any) => any, string>(tezosClientMock.getBigMapValue).first()[1](contractStorageShape)).toBe('a');
        });
    });
});
